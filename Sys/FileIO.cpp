...
---/__|" '' "| /___/\----   Your Dream: Getaway | Our Mission: Manage
   ...
   `""`""))""`"`""""        created by r0834721 for a summer retake. All rights reserved)---";
    ...
    std::cout  << " Use the app as:    1. Abonnee   2. Beheerder  3. Staff 4.I've had enough (quit) \n" ;
    std::cout  << "----------------------------------------------------------\n\n" ;
...
inline void FileIO::beheerderZieAbonneeMenu() {
    ...
    switch (keuze) {
        case 1:
            ...
            std::cout << "\n";
            std::cout  << abonnees.size() + 1 << ".Back to beheerder menu\n" ;
...
inline void FileIO::beheerderZieParkMenu() {
    ...
    switch (keuze) {
        case 1:
            ...
            std::cout << "\n";
            std::cout  << parkVector.size() + 1 << ".Back to beheerder menu\n" ;
...
//    CANNOT DO Beheerder* bc declared at top Classe
    beheerder = new Owner(name, address,mail,password);
}
